...
<body>
 <section class="headsec">
      <div class="header">
           ...
           <div  class="college"><h1 style="color:#004764">JAWAHARLAL NEHRU TECHNOLOGICAL UNIVERSITY<br></h1><h2 style="color:#F04393" > Computer Science and Engineering </h2>
             <div>
     ...
     <div class=" info">
             <div class="info-left">
                     <table>
                          ...
                          <tr height="60px" ><td>  <p style="color:#00081B"> 17A55401: </td> <td><a href="ms.php">&ensp;<?php  echo $r2['sub1']?></a> </p></td></tr>
                          <tr height="60px" ><td>  <p style="color:#00081B"> 17A50501:</td>  <td><a href="web.php">&ensp;<?php  echo $r2['sub2']?></a></p></td></tr>
                          <tr height="60px" ><td>  <p style="color:#00081B"> 17A50502: </td> <td><a href="compiler.php">&ensp;<?php  echo $r2['sub3']?></a></p></td></tr>
                          <tr height="60px" ><td>  <p style="color:#00081B"> 17A50505:  </td>  <td><a href="datawarehouse.php">&ensp;<?php  echo $r2['sub4']?></a></p></td></tr>
                          <tr height="60px" ><td>  <p style="color:#00081B"> 17A50503:</td> <td><a href="se.php">&ensp;<?php  echo $r2['sub5']?></a></p></td></tr>
                          <tr height="60px" ><td>    <p style="color:#00081B"> 17A50504:  </td>  <td><a href="cn.php">&ensp;<?php  echo $r2['sub6']?></a></p></td></tr>
             ...
             <div class="info-right">
                     <div class="panelmain">
                       ...
                       <div class="panel">
                         <div class="a" style="background-color:#004764"><h1 style="color:#ffffff"><strong >Notice Board</strong></h1> </div>
                         <div class="ph">
                         <p  class="b">
                               <?php
                                  $q3="SELECT notice FROM noticeboard";
                                  $result3=mysqli_query($con,$q3) or die("bad query");
                                  while($r3=mysqli_fetch_assoc($result3)){
                                  echo $r3['notice']; ?><br></br><?php
                                    }
                                  ?>
                             </p>
                          </div>
                      ...
                      <div class="panel">
                        <div class="a" style="background-color:#004764"><h1  style="color:#ffffff"><strong>Events</strong></h1></div>
                          <div class="ph">
                            <p class="b">
                            <?php
                                $q4="SELECT event FROM events";
                                $result4=mysqli_query($con,$q4) or die("bad query");
                                while($r4=mysqli_fetch_assoc($result4)){
                                  echo $r4['event']; ?><br></br><?php
                                }
                                ?>
                            </p>
                         </div>
              ...
              <div class="panel">
                 <div   class="a" style="background-color:#004764"><h1  style="color:#ffffff"><strong> Answered Queries</strong></h1> </div>
                   <div class="ph">
                      <p  class="b">
                     <?php
                     $q5="SELECT answer FROM query_answered";
                       $result5=mysqli_query($con,$q5) or die("bad query");
                        while($r5=mysqli_fetch_assoc($result5)){
                          echo $r5['answer']; ?><br></br><?php
                        }
                     ?>
                   </p>
                  </div>
 ...
 <section class="querysec">
   <div class="queryform">
     <div class="query1">
       <form class="query2" action="query.php" method="post">
         <input class="query3" type="text" name="query"  placeholder="enter query..."  required></input><br><br>
         <input  class="query4" type="text" name="rollno"    placeholder="roll no"  required></input><br><br>
